...
import {NEW_POST_PAGE} from "../Router/Routes";
            ...
            <div className="mt-8">
                <form action="#" autoComplete="off">
                    ...
                    <div className="flex w-full">
                        <button type="submit"
                                className="py-2 px-4  bg-blue-600 hover:ring-offset-blue-900 focus:ring-blue-900-500 focus:ring-offset-blue-900-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                            Login
                        </button>
                    </div>
                </form>
