    ...
    <div className="relative inline-block text-left h-16 w-full">
      <div className="w-full flex justify-between h-16 items-center">
        ...
        <div className="mr-4 flex items-center md:ml-6">
          ...
          <div className="ml-2 font-mono font-bold text-2xl">Blockich</div>
        </div>
      </div>

      {(props.forceOpen || isOpen) && (
        <div className="absolute left-4 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-50">
          <div
            className={`py-1 ${
